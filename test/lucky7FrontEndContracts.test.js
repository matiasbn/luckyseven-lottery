...
contract('Lucky7FrontEndFunctions', (accounts) => {
  ...
  it('should read the lastLucky7TicketsOwner correctly', async () => {
    ...
    const lucky7FrontEndFunctions = await Lucky7FrontEndFunctions.new();
    const lucky7LastDIfference0 = await lucky7FrontEndFunctions.getLastLucky7Difference(accounts[0]);
    const lucky7LastDIfference1 = await lucky7FrontEndFunctions.getLastLucky7Difference(accounts[1]);
    const lucky7LastDIfference2 = await lucky7FrontEndFunctions.getLastLucky7Difference(accounts[2]);
    const lucky7LastDIfference3 = await lucky7FrontEndFunctions.getLastLucky7Difference(accounts[3]);
    const lucky7LastDIfference4 = await lucky7FrontEndFunctions.getLastLucky7Difference(accounts[4]);
    const lucky7LastDIfference5 = await lucky7FrontEndFunctions.getLastLucky7Difference(accounts[5]);
    const lucky7LastDIfference6 = await lucky7FrontEndFunctions.getLastLucky7Difference(accounts[6]);
    const lucky7LastDIfference7 = await lucky7FrontEndFunctions.getLastLucky7Difference(accounts[7]);

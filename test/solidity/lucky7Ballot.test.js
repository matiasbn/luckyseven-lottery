...
contract('Lucky7Ballot', (accounts) => {
  ...
  it('should ask for a new ticket and check if it is a Lucky7Ticket', async () => {
    ...
    const firstExactLucky7Ticket = await lucky7Ballot.ExactLucky7TicketValue(0);
    const firstExactLucky7Owner = await lucky7Ballot.ExactLucky7TicketOwner(0);
    const firstExactLucky7ID = await lucky7Ballot.ExactLucky7TicketID(0);
    const indexForExactLucky7Ticket = await lucky7Ballot.indexForExactLucky7Ticket();
  ...
  it('should not change the Lucky7Ticket owner if it is exact', async () => {
    ...
    const ownerOfFirstExactLucky7Ticket = await lucky7Ballot.ExactLucky7TicketOwner(0);
    ...
    const ownerOfSecondExactLucky7Ticket = await lucky7Ballot.ExactLucky7TicketOwner(1);
  ...
  it('should properly clean the mappings ', async () => {
    ...
    const ExactLucky7TicketValue0 = await lucky7Ballot.ExactLucky7TicketValue(0);
    const ExactLucky7TicketOwner0 = await lucky7Ballot.ExactLucky7TicketOwner(0);
    const ExactLucky7TicketID0 = await lucky7Ballot.ExactLucky7TicketID(0);

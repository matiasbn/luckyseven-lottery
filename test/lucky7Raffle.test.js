...
const Lucky7StoreArtifact = require('../build/contracts/Lucky7Store')
...
const web3Contract = (address) => {
  ...
  return new web3.eth.Contract(Lucky7StoreArtifact.abi, address);
}
...
contract('Lucky7Raffle', (accounts) => {
  ...
  beforeEach(async function () {
    ...
    lucky7Raffle = await Lucky7Store.new(lightHouse.address, true, {
